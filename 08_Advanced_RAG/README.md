...
Advanced retrieval patterns that depend on already knowing agents (Phase 5) and advanced agentic systems (Phase 7) — deliberately sequenced after both, not bundled into Phase 4's foundational RAG.
