...
> **Prerequisites:** [The 60-Minute Whiteboard Method](../../02_System_Design_Fundamentals/05_The_60_Minute_Whiteboard_Method.md); Module 04
> **Source material:** `05_Projects/Enterprise_RAG_Platform/INTERVIEW_SCRIPT.md` — kept as a performance artefact: a full six-step script, minute by minute, with the lines that carry each step. Read the method first; rehearse from this.
