...
> **Source material:** `05_Projects/Enterprise_RAG_Platform/INTERVIEW_SCRIPT_DATABRICKS.md` — kept as a performance artefact: a full six-step script, minute by minute, with the lines that carry each step. Read the method first; rehearse from this.
