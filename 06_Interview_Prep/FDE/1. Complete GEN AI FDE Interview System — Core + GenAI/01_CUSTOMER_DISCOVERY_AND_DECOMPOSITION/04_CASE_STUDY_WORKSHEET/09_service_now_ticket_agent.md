# ServiceNow Ticket Automation Agent - Case Study Worksheet

## 1. Interview prompt
Design a GenAI FDE solution for **ServiceNow Ticket Automation Agent**. The customer has ambiguous requirements, sensitive data, and expects a production rollout, not a demo.
