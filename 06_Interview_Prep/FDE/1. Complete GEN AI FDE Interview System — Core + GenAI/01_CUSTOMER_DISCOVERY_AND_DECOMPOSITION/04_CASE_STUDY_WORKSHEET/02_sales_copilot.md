# Sales Copilot for Account Executives - Case Study Worksheet

## 1. Interview prompt
Design a GenAI FDE solution for **Sales Copilot for Account Executives**. The customer has ambiguous requirements, sensitive data, and expects a production rollout, not a demo.
