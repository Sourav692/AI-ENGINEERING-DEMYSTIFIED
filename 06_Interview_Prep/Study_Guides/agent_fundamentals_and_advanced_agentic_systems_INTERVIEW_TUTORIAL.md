...
| | |
|---|---|
| **Source** | `02_Core/05_AI_Agent_Fundamentals/`, `03_Advanced/07_Advanced_Agentic_Systems/` |
| **Notebooks** | 162 |
| **Built** | 2026-09-09 |
...
**Code** (`02_Core/05_AI_Agent_Fundamentals/2. LangChain_Tools_and_Agents/01_Tools_and_Functions/6.2_Tool_Calling_Agents.ipynb`):
```python
...
**Code** (`02_Core/05_AI_Agent_Fundamentals/2. LangChain_Tools_and_Agents/01_Tools_and_Functions/6.1_Tool_Calling_LangChain.ipynb`):
```python
...
**Code** (`02_Core/05_AI_Agent_Fundamentals/5. Agent Pattern/02_Planning/02_Planning_Decompose_Execute_Replan.ipynb`):
```python
...
**Code** (`02_Core/05_AI_Agent_Fundamentals/5. Agent Pattern/04_Advanced_Cognitive_Patterns/01_PEV.ipynb`):
```python
...
**Code** (`03_Advanced/07_Advanced_Agentic_Systems`-adjacent, `02_Core/05_AI_Agent_Fundamentals/5. Agent Pattern/03_Reflection/02_Reflexion_Agents.ipynb`):
```python
...
**Code** (`03_Advanced/07_Advanced_Agentic_Systems/Multi_Agent_Orchestration/Production_Course_Multi_Agent/02_supervisor_agent.ipynb`):
```python
...
**Code** (`03_Advanced/07_Advanced_Agentic_Systems/Multi_Agent_Orchestration/03_Blackboard/01_Blackboard.ipynb`):
```python
...
**Code** (`03_Advanced/07_Advanced_Agentic_Systems/Memory_and_State/LangGraph/01_Memory/memory/05_Long_Term_Semantic_Memory_SQLite.ipynb`):
```python
...
**Code** (pattern from `03_Advanced/07_Advanced_Agentic_Systems/Deep_Agents_and_Harness_Engineering/examples/long_term_memory_agent.py`, shape only):
```python
...
**Code** (`02_Core/05_AI_Agent_Fundamentals/3. AI_Agents_with_LangGraph/10_Hotel_Reservations_Multi_Agent_System/Module_2_Core_Agents/5_Edge_Cases_and_Errors.ipynb`):
```python
...
**Code** (`02_Core/05_AI_Agent_Fundamentals/4. Workflow_Pattern/4. Orchestrator_Worker/notebooks/Orchestrator_Worker.ipynb`):
```python
...
**Code** (`02_Core/05_AI_Agent_Fundamentals/4. Workflow_Pattern/5. Evaluator_Optimizer/notebooks/Evaluator_Optimizer.ipynb`):
```python
