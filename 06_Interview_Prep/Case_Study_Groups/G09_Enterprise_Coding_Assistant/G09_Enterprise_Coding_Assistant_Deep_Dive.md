...
The [Main guide](G09_Enterprise_Coding_Assistant_Main.md) is the spoken answer. This backs it with mechanisms from the unchanged [source study](G09_Enterprise_Coding_Assistant.md), especially §§3–13.
