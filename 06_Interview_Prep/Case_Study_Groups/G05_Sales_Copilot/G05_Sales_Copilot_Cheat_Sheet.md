...
Use the [Main guide](G05_Sales_Copilot_Main.md) to practice speaking and the [Deep Dive](G05_Sales_Copilot_Deep_Dive.md) for mechanisms. The [source](G05_Sales_Copilot.md) is the full reference.
