...
|---|---|---|---|
| 01 | [LangChain Foundations](01_langchain_foundations_INTERVIEW_TUTORIAL.md) | `01_LangChain_Fundamentals` (whole folder) | Everything is a Runnable, and `\|` composes them |
| 04 | [RAG & Retrieval](04_rag_and_retrieval_INTERVIEW_TUTORIAL.md) | `04_Retrieval_and_RAG` (subfolders 01-06) | Retrieval and generation fail independently |
| 03 | [LangGraph Fundamentals](03_langgraph_fundamentals_INTERVIEW_TUTORIAL.md) | `03_LangGraph_Fundamentals` (whole folder) | Checkpointing gives you memory, approval and time travel |
| 07 | [Multi-Agent Systems](07_multi_agent_systems_INTERVIEW_TUTORIAL.md) | `07_Advanced_Agentic_Systems/Multi_Agent_Orchestration/Production_Course_Multi_Agent` | Most multi-agent systems should be one agent |
| 12 | [Production & Operations](12_production_and_operations_INTERVIEW_TUTORIAL.md) | `12_Production_and_Observability` (whole folder, evaluation excluded) | If you can't measure it, you can't defend it |
...
| [07 — Agent Memory & State](07_memory_and_state_INTERVIEW_TUTORIAL.md) | `07_Advanced_Agentic_Systems/Memory_and_State/` (`Agentic_Memory_Architectures/`, `LangChain/Memory/`, `LangGraph/`; 22 notebooks) | 2026-09-16 |
| [08 — Advanced RAG Techniques](08_advanced_rag_techniques_INTERVIEW_TUTORIAL.md) | `08_Advanced_RAG/Comprehensive_RAG_Techniques/` (`all_rag_techniques/`, `all_rag_techniques_runnable_scripts/`; excludes `evaluation/`) + `08_Advanced_RAG/RAG_with_LangGraph_Advanced/` (48 notebooks) | 2026-09-16 |
...
numbers match their source folder — `07_Advanced_Agentic_Systems/Memory_and_State` and
`08_Advanced_RAG` — which is also why `07` is shared with the Multi-Agent Systems
tutorial (both live under `07_Advanced_Agentic_Systems`, different subfolders).
