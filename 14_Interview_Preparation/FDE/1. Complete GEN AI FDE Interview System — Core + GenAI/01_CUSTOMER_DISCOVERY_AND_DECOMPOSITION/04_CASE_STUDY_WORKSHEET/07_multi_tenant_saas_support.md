# Multi-Tenant SaaS Support Assistant - Case Study Worksheet

## 1. Interview prompt
Design a GenAI FDE solution for **Multi-Tenant SaaS Support Assistant**. The customer has ambiguous requirements, sensitive data, and expects a production rollout, not a demo.
