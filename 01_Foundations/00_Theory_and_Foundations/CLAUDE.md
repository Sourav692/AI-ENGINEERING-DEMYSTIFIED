...
| `Reasoning_and_Model_Selection/` | Built | Reasoning vs non-reasoning, measured; effort levers and the knee (2 nb). Added 2026-09-19 as a sibling track, not a module inside `Model_Landscape_and_Hugging_Face/` — that track is the HF ecosystem, and API-reached frontier models are not that |
