# Phase 6 — Agent SDKs (First-Party)

**Status:** 🚧 Planned — no content yet.

First-party agent SDKs from the major labs, as their own phase — a distinct paradigm from the LangChain/LangGraph frameworks covered in Phases 2–5.
