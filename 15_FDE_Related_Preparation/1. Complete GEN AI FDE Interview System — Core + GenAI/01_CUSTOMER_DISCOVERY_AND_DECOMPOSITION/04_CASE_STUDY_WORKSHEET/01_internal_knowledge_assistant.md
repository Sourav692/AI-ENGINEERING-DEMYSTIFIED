# Internal Knowledge Assistant for Enterprise Support - Case Study Worksheet

## 1. Interview prompt
Design a GenAI FDE solution for **Internal Knowledge Assistant for Enterprise Support**. The customer has ambiguous requirements, sensitive data, and expects a production rollout, not a demo.
