...
- [Documentation](https://python.langchain.com/docs/06_Interview_Prep/Study_Guides/rag/)
- End-to-end Example: [Chat LangChain](https://chat.langchain.com) and [repo](https://github.com/langchain-ai/chat-langchain)

**🧱 Extracting structured output**

- [Documentation](https://python.langchain.com/docs/06_Interview_Prep/Study_Guides/extraction/)
- End-to-end Example: [LangChain Extract](https://github.com/langchain-ai/langchain-extract/)

**🤖 Chatbots**

- [Documentation](https://python.langchain.com/docs/06_Interview_Prep/Study_Guides/chatbot/)
- End-to-end Example: [Web LangChain (web researcher chatbot)](https://weblangchain.vercel.app) and [repo](https://github.com/langchain-ai/weblangchain)

And much more! Head to the [Tutorials](https://python.langchain.com/docs/06_Interview_Prep/Study_Guides/) section of the docs for more.
...
Check out the LangChain [tutorials page](https://python.langchain.com/docs/06_Interview_Prep/Study_Guides/#orchestration) for examples.
...
LangChain components to build both [custom](https://langchain-ai.github.io/langgraph/06_Interview_Prep/Study_Guides/)
...
- [Tutorials](https://python.langchain.com/docs/06_Interview_Prep/Study_Guides/): If you're looking to build something specific or are more of a hands-on learner, check out our tutorials. This is the best place to get started.
