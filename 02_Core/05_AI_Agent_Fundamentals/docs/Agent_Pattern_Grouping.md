...
```
02_Core/05_AI_Agent_Fundamentals/                    # Layers A + B only
...
03_Advanced/07_Advanced_Agentic_Systems/                 # Layer C — coordination + memory
├── Memory_and_State/
└── Multi_Agent_Orchestration/

03_Advanced/08_Advanced_RAG/                             # Layer C — agentic retrieval
03_Advanced/09_Agent_Protocols/                          # Layer C — MCP, A2A
03_Advanced/12_Production_and_Observability/             # Layer C — safety, guardrails, HITL ops
02_Core/03_LangGraph_Fundamentals/…/Human_in_the_Loop/   # HITL mechanics (LangGraph)
```
...
### Phase 7 — `03_Advanced/07_Advanced_Agentic_Systems/`
...
### Phase 8 — `03_Advanced/08_Advanced_RAG/`
...
### Phase 9 — `03_Advanced/09_Agent_Protocols/`
...
#### `02_Core/03_LangGraph_Fundamentals/…/Human_in_the_Loop/` (mechanics)
...
#### `03_Advanced/12_Production_and_Observability/Safety_and_Alignment/`
...
#### `03_Advanced/12_Production_and_Observability/` (exceptions, cost, resources)
...
#### Phase 6 — `03_Advanced/06_Agent_SDKs_First_Party/`
...
#### Phase 10 — `03_Advanced/10_Alternative_Agent_Frameworks/`
...
Home: `02_Core/05_AI_Agent_Fundamentals/4. Workflow_Pattern/`.
...
### Agentic retrieval — Phase 8 `03_Advanced/08_Advanced_RAG/`
...
### Protocols — Phase 9 `03_Advanced/09_Agent_Protocols/`
