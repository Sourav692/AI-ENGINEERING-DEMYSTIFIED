...
- Original LangChain repository:
    - [Reflection](https://github.com/langchain-ai/langgraph/blob/main/docs/docs/06_Interview_Prep/Study_Guides/reflection)
    - [Reflexion](https://github.com/langchain-ai/langgraph/tree/main/docs/docs/06_Interview_Prep/Study_Guides/reflexion)
