...
Worked versions live in `03_Advanced/07_Advanced_Agentic_Systems/Memory_and_State/`.
...
Phase 3 (`02_Core/03_LangGraph_Fundamentals/`) and Phase 5 (`02_Core/05_AI_Agent_Fundamentals/`) cover that lower level.
