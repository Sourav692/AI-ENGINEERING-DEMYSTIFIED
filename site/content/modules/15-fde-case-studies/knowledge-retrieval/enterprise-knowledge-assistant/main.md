...
Ask the questions that change a design decision. The [source case, §1](/modules/15-fde-case-studies/knowledge-retrieval/enterprise-knowledge-assistant#full-pack) expands these into the full discovery table.
...
This is the interview-size version of the [source architecture, §5](/modules/15-fde-case-studies/knowledge-retrieval/enterprise-knowledge-assistant#full-pack).
