...
This is the anchor for the related executive-dashboard and retail-forecast explanation cases in the [source study](/modules/15-fde-case-studies/knowledge-retrieval/nl-over-governed-data#full-pack). Learn the governed query path once; change the final explanation and review workflow for each variant.
...
This is the interview-size view of the [source architecture, §4](/modules/15-fde-case-studies/knowledge-retrieval/nl-over-governed-data#full-pack). The LLM interprets and explains; registry, policy, warehouse, and analysts keep authority.
