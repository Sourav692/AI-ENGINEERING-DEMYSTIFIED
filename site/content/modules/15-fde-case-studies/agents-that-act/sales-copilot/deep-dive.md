...
Use the [Main guide](/modules/15-fde-case-studies/agents-that-act/sales-copilot#main) for the spoken answer. This is the technical backup; the unchanged [source case](/modules/15-fde-case-studies/agents-that-act/sales-copilot#full-pack) keeps the full synthesis, interview script, and references.
...
The [source](/modules/15-fde-case-studies/agents-that-act/sales-copilot#full-pack) retains the original sixty-minute script, detailed source attribution, and trace excerpt.
