...
Use the [Main guide](/modules/15-fde-case-studies/agents-that-act/sre-incident-response-agent#main) to practice speaking and the [Deep Dive](/modules/15-fde-case-studies/agents-that-act/sre-incident-response-agent#deep-dive) for technical follow-ups. The [source](/modules/15-fde-case-studies/agents-that-act/sre-incident-response-agent#full-pack) is the full reference.
