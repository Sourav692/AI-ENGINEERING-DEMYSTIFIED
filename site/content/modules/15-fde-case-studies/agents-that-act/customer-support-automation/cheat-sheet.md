...
Use the [Main guide](/modules/15-fde-case-studies/agents-that-act/customer-support-automation#main) for the spoken answer and the [Deep Dive](/modules/15-fde-case-studies/agents-that-act/customer-support-automation#deep-dive) for technical follow-ups. The [source case](/modules/15-fde-case-studies/agents-that-act/customer-support-automation#full-pack) remains the full reference.
