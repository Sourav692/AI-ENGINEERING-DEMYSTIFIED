...
> **Source:** [G18_Consumer_Scale_Chat_Service.md](/modules/15-fde-case-studies/platforms-and-scale/consumer-scale-chat-service#full-pack), especially §§1–12. Use the [Deep Dive](/modules/15-fde-case-studies/platforms-and-scale/consumer-scale-chat-service#deep-dive) for sizing and trade-offs and the [Cheat Sheet](/modules/15-fde-case-studies/platforms-and-scale/consumer-scale-chat-service#cheat-sheet) for rehearsal. The source builds its design from one-line “Design ChatGPT/Claude” prompts; all scale figures are explicit whiteboard assumptions, not measured service facts.
