# Retail Demand Forecast Explanation Assistant - Case Study Worksheet

## 1. Interview prompt
Design a GenAI FDE solution for **Retail Demand Forecast Explanation Assistant**. The customer has ambiguous requirements, sensitive data, and expects a production rollout, not a demo.
