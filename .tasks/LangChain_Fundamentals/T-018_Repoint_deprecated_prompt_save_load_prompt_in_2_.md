---
id: T-018
title: Repoint deprecated prompt save/load_prompt in 2.2
type: migration
status: done
review: approved
review_rounds: 1
...
updated: 2026-09-05
---
- [x] **Repoint deprecated prompt save/load_prompt in 2.2** — `done` · review: ✓ approved · round 1

## Objective

2.2 cells 23-25 teach BasePromptTemplate.save and load_prompt. Both are deprecated as of langchain-core 1.2.21 (installed 1.6.1) in favour of dumpd/dumps + load/loads from langchain_core.load. They still work, so this is MODERNIZE not BLOCKING, but the section emits a LangChainDeprecationWarning on every run while teaching the deprecated call. Surfaced by the T-011 review; deliberately not absorbed into T-011, whose rule was IMP-prompts.
