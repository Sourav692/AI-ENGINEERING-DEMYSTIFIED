...
**Still open:**
- **154 notebooks** don't open with a proper `# Title` markdown cell (mid-document subheading, or a code cell first). Counted 2026-09-19 across the whole repo excluding `archive/` and `site/`. Pre-existing and deliberately not fixed — it would mean editing notebook content in 154 files.
